      ...
      <div className="receipt-card glow-temu animate-pop">
        ...
        {!purchased ? (
          ...
          <div className="checkout-confirm-box">
            ...
            <div className="item-hero-icon">🎁</div>
            <h2 className="item-title">{item.name}</h2>

            <div className="price-tag-big">
              <span>필요 스탬프:</span>
              <strong className="gold-text">{item.price} STAMP</strong>
            </div>

            <div className="balance-calc-box">
              <div className="calc-row">
                <span>현재 보유 스탬프:</span>
                <span>{studentPoints} STAMP</span>
              </div>
              <div className="calc-row">
                <span>차감 스탬프:</span>
                <span className="text-red">-{item.price} STAMP</span>
              </div>
              <div className="calc-row total">
                <span>구매 후 잔액:</span>
                <span className={canAfford ? 'text-green' : 'text-red'}>
                  {remainingAfter} STAMP
                </span>
              </div>
            </div>
            ...
            {!canAfford && (
              <div className="warning-banner">
                ...
                <span>스탬프가 부족합니다! (부족: {Math.abs(remainingAfter)} STAMP)</span>
              </div>
            )}
            ...
            <div className="receipt-paper">
              ...
              <div className="receipt-body">
                <div className="receipt-item-info">
                  ...
                  <span className="r-price">-{item.price} STAMP</span>
                </div>
                ...
                <div className="receipt-summary">
                  <div className="r-row">
                    <span>사용한 스탬프:</span>
                    <strong>{item.price} STAMP</strong>
                  </div>
                  <div className="r-row">
                    <span>남은 스탬프:</span>
                    <strong className="gold-text">{remainingAfter} STAMP</strong>
                  </div>
                </div>
              </div>
